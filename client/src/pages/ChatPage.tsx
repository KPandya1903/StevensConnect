...
export function ChatPage() {
  ...
  return (
    <div className="flex h-dvh flex-col bg-gray-50">
      ...
      {/* Composer */}
      <div className="border-t border-gray-200/80 bg-white/90 px-4 py-3 pb-[max(0.75rem,env(safe-area-inset-bottom))] backdrop-blur-sm">
        <div className="flex items-end gap-2.5">
          ...
          <button
            onClick={handleSend}
            disabled={!draft.trim()}
            className="flex h-11 w-11 shrink-0 items-center justify-center rounded-full bg-gradient-to-br from-brand-600 to-violet-500 text-white shadow-sm transition hover:shadow-lift hover:opacity-90 disabled:opacity-40 disabled:cursor-not-allowed"
          >
